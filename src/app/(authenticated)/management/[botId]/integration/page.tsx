...
import { Box, Button, Fade, styled, Switch, Typography } from "@mui/material";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Switch onChange={handleChangeSwitch} sx={{ padding: "10px" }} />
      </Box>
      ...
      {checkedSwitch && (
        <Fade in={checkedSwitch}>
          ...
          >
            ...
            >
              <Typography>
                Sao chép và dán mã bên dưới vào trang web của bạn
              </Typography>
              <Box
                sx={(theme) => ({
                  borderRadius: "8px",
...
<script	id="codechat-script"
	...
	botToken="${botId}">
              ...
              <Button
                ...
                variant="outlined"
                onClick={() => {
                  const textToCopy = textAreaScriptRef.current?.value || "";
	...
	allow="clipboard-read; clipboard-write; autoplay; encrypted-media; fullscreen; display-capture">
              ...
              <Button
                ...
                variant="outlined"
                onClick={() => {
                  const textToCopy = textAreaIFrameRef.current?.value || "";
